...
public class SIARDDKModuleFactory implements DatabaseModuleFactory {
  ...
  public static final Parameter clobsList = new Parameter().shortName("cl").longName("clobList")
    .description("List of CLOBs (generated by the list-tables export module) to convert to tiff").hasArgument(true)
  ...
  public Map<String, Parameter> getAllParameters() {
    ...
    parameterMap.put(clobsList.longName(), clobsList);
  ...
  public DatabaseExportModule buildExportModule(Map<Parameter, String> parameters)
    ...
    String pClobsList = parameters.get(clobsList);
    ...
    exportModuleArgs.put(clobsList.longName(), pClobsList);
